...
class SettingsActivity : BaseActivity(), View.OnClickListener {
    ...
    private fun setupActionBar() {
        val toolbar = findViewById<androidx.appcompat.widget.Toolbar>(R.id.action_settings)
    ...
    fun getUserDetailsSuccess(user: User) {
        ...
        //REMEMBER TO COME BACK AND MAKE CORRECTION.
        tv_name.text = "${user.firstName} ${user.firstName}"
